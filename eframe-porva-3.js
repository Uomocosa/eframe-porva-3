...
function __wbg_adapter_30(arg0, arg1) {
    const ret = wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he92b23f3a8531bef_multivalue_shim(arg0, arg1);
    if (ret[1]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('eframe-porva-3_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
